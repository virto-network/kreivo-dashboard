    ...
    <div className="block-detail-event">
      <div className="block-detail-event-header">
        <div className="block-detail-event-main">
          <div className="block-detail-event-type-badge">
            {eventType}
          </div>
          {phase && (
            <div className="block-detail-event-phase">
              {phase}
            </div>
          )}
        </div>
        ...
        <div className="block-detail-event-summary">
          {details.weight && (
            <div className="block-detail-event-detail-item">
              ...
              <span className="block-detail-event-detail-value">{details.weight}</span>
            </div>
          )}
          {details.proofSize && details.proofSize !== 'O' && (
            <div className="block-detail-event-detail-item">
              <span className="block-detail-event-detail-label">Proof Size:</span>
              <span className="block-detail-event-detail-value">{details.proofSize}</span>
            </div>
          )}
          {details.class && (
            <div className="block-detail-event-detail-item">
              <span className="block-detail-event-detail-label">Class:</span>
              <span className="block-detail-event-detail-value">{details.class}</span>
            </div>
          )}
          {details.paysFee && (
            <div className="block-detail-event-detail-item">
              <span className="block-detail-event-detail-label">Pays Fee:</span>
              <span className="block-detail-event-detail-value">{details.paysFee}</span>
            </div>
          )}
        </div>
      )}
...
const BlockDetail: React.FC = () => {
  ...
  const blockInfo = useStateObservable(
    blockInfoState$(blockNumber || '')
  );
    ...
    <div className="block-detail-page">
      <div className="block-detail-container">
        <div className="block-detail-header">
          ...
          <h1 className="block-detail-title">Block #{blockInfo.number.toLocaleString()}</h1>
          <div className={`block-detail-status block-status-${blockInfo.status}`}>
            {blockInfo.status}
          </div>
        </div>
        ...
        <div className="block-detail-content">
          <div className="block-detail-section">
            ...
            <div className="block-detail-info-grid">
              <div className="block-detail-info-item">
                ...
                <span className="block-detail-value">{blockInfo.number.toLocaleString()}</span>
              </div>
              <div className="block-detail-info-item">
                <span className="block-detail-label">Hash:</span>
                <span className="block-detail-value block-detail-hash">{formatHash(blockInfo.hash)}</span>
              </div>
              <div className="block-detail-info-item">
              ...
              <div className="block-detail-info-item">
                ...
                <span className="block-detail-value block-detail-hash">
                  {blockInfo.header?.stateRoot ? formatHash(blockInfo.header.stateRoot) : 'N/A'}
                </span>
              </div>
              <div className="block-detail-info-item">
                <span className="block-detail-label">Extrinsics Root:</span>
                <span className="block-detail-value block-detail-hash">
                  {blockInfo.header?.extrinsicRoot ? formatHash(blockInfo.header.extrinsicRoot) : 'N/A'}
                </span>
              </div>
              <div className="block-detail-info-item">
          ...
          {blockInfo.events && blockInfo.events.length > 0 && (
            <div className="block-detail-section">
              <h2 className="block-detail-section-title">Events ({blockInfo.events.length})</h2>
          ...
          {blockInfo.body && blockInfo.body.length > 0 && (
            <div className="block-detail-section">
              <h2 className="block-detail-section-title">Extrinsics ({blockInfo.body.length})</h2>
              <div className="block-detail-extrinsics">
                {blockInfo.body.map((extrinsic: string, index: number) => (
                  <div key={index} className="block-detail-extrinsic">
                    ...
                    <div className="block-detail-extrinsic-hash">{formatHash(extrinsic)}</div>
                  </div>
                ))}
              </div>
            </div>
